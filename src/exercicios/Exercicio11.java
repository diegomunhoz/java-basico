...
/**
 * Programa para receber dois valores do usuario e exibir a multiplicação dos valores
 * 
 * @author Diego Munhoz
 * @since 05/02/2021
 */
public class Exercicio11 {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, num1 + " x " + num2 + " = " + res, "Resultado do calculo", 1);
